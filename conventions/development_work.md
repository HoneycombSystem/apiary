...
### Epics
Epics are large bodies of work that can be broken down into a number of smaller features.

#### Example
Overhauling the user interface of a website would be an epic that you could break down into stories for each page or each major web UI element.

#### Example
Implementation of Private Messaging

### Feature
Feature are a group of user stories and use cases that have a common epic. They are a collection of functionality that satisfies a stakeholder need. Features are the main way you can organize and prioritize work in a project.

The feature can be divided into several subfeatures, which are implemented at different stages.

#### Convention subfeatures naming
- **A** - for POC (Proof of Concept) and MVP (Minimum Viable Product) implementation. Minimum functionalities to allow testing
- **B** - for MMP (Minimum Marketable Product) implementation. Minimum functionalities to sell the product
- **C** -
...
### Task
A task is a unit of work that, when performed, contributes to the completion of a larger job. A task can be broken down into assignments for individuals, but ideally it should be a sufficiently small job that it can be accomplished within a few days.
...
## Development process
### 1. Create a theme
* The theme name **MUST** be added into the file `themes/themes.md` with short description.
* The theme **MUST** be described in the file `themes/<theme_name>/theme.md`.
...
### 2. Create an epic
* The epic name **MUST** be added into the file `themes/<theme_name>/epics.md` with short description.
* The epic **MUST** be described in the file `themes/<theme_name>/<epic_name>/epic.md`.
...
### 3. Create a feature
* The feature name **MUST** be added into the file `themes/<theme_name>/<epic_name>/features.md` with short description.
* The feature **MUST** be described in the file `themes/<theme_name>/<epic_name>/<feature_name>/feature.md`.
...
* The user story name **MUST** be added into the file `themes/<theme_name>/<epic_name>/<feature_name>/user_stories.md` with short description.
* The user story **MUST** be described in the file `themes/<theme_name>/<epic_name>/<feature_name>/<user_story_name>/user_story.md`.
...
* The acceptance criteria **MUST** be described in the file `themes/<theme_name>/<epic_name>/<feature_name>/<user_story_name>/acceptance_criteria.md`.

### 6. Create a task
* The task name **MUST** be added into github issues with short description.

### 7. Schema of the project structure
```
apiary
│
└───conventions
